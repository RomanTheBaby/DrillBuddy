...
//  DrillBuddy
//
//  Created by Roman on 2023-09-15.
//
...
final class AudioClassifier: NSObject {
    ...
    // MARK: - SystemAudioClassificationError
    ...
    private let analysisQueue = DispatchQueue(label: "com.bakehouse.classifying-sounds.AnalysisQueue")
